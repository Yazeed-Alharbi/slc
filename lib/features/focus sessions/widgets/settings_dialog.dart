...
class SettingsDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pomodoroController = TextEditingController(text: pomodoroMinutes.toString());
    final shortBreakController = TextEditingController(text: shortBreakMinutes.toString());
    final longBreakController = TextEditingController(text: longBreakMinutes.toString());
    final longBreakIntervalController = TextEditingController(text: longBreakInterval.toString());
          ...
          Row(
            ...
            children: [
              ...
              SLCButton(
                ...
                onPressed: () {
                  // Parse values
                  final pomodoro = int.tryParse(pomodoroController.text) ?? pomodoroMinutes;
                  final shortBreak = int.tryParse(shortBreakController.text) ?? shortBreakMinutes;
                  final longBreak = int.tryParse(longBreakController.text) ?? longBreakMinutes;
                  final interval = int.tryParse(longBreakIntervalController.text) ?? longBreakInterval;
