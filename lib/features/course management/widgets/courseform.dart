...
class _CourseFormScreenState extends State<CourseFormScreen> {
  ...
  void _validateAndSave() async {
    ...
    try {
      ...
      final courseRepository = CourseRepository(firestoreUtils: FirestoreUtils());
      ...
      if (isEditing) {
        ...
        final newCourse = await courseRepository.createCourse(
          name: titleController.text,
          code: nameController.text,
          description: "Course Description", // Consider adding description field
          color: selectedColor,
          days: selectedDays,
          startTime: startTime,
          endTime: endTime,
